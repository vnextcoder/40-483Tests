...
namespace Customers
{
    public class ViewModel : INotifyPropertyChanged
    {
        ...
        public ViewModel()
        {
            ...
            this.FirstCustomer = new Command(this.First, () => { return this.customers.Count > 0 && !this.IsAtStart; });
            this.LastCustomer = new Command(this.Last, () => { return this.customers.Count > 0 && !this.IsAtEnd; });
